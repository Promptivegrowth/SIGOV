...
export const PRELIMINARES = [
...

  {
    ...
    bloques: [
      ...
      { tipo: 'parrafo', texto: 'Las siete cuentas usan la **misma contraseña**, tanto en el panel web como en la aplicación del celular. Escríbela tal cual: con la ese mayúscula al inicio y el signo de admiración al final.' },
      {
        tipo: 'clave',
        titulo: 'Contraseña de todas las cuentas',
        valor: 'Sigov2026!',
        nota: 'Diez caracteres: la **S** en mayúscula, el año **2026** y el signo **!** al final. Si el sistema dice «Credenciales incorrectas», lo más probable es que falte ese signo.',
      },
      {
        tipo: 'tabla',
        columnas: ['Correo', 'Contraseña', 'Nombre', 'Rol en el sistema', 'Cuadrilla'],
        filas: [
          ['`admin@sigov.dev`', '`Sigov2026!`', 'Luis Bravo Camus', 'Administrador', '—'],
          ['`supervisor@sigov.dev`', '`Sigov2026!`', 'Elvis Dueñas Cabrera', 'Supervisor', '—'],
          ['`cuadrilla1@sigov.dev`', '`Sigov2026!`', 'Marco Quispe Ramos', 'Jefe de cuadrilla', 'CUA-01 · Calzada y Drenaje'],
          ['`cuadrilla2@sigov.dev`', '`Sigov2026!`', 'Rosa Huamán Ticona', 'Jefe de cuadrilla', 'CUA-02 · Señalización'],
          ['`cuadrilla3@sigov.dev`', '`Sigov2026!`', 'Julio Cárdenas Vega', 'Jefe de cuadrilla', 'CUA-03 · Derecho de vía'],
          ['`ssoma@sigov.dev`', '`Sigov2026!`', 'Paola Ríos Mendoza', 'Ing. de seguridad', '—'],
          ['`visor@sigov.dev`', '`Sigov2026!`', 'Supervisión OSITRAN', 'Visor (solo lectura)', '—'],
        ],
      },
      {
        tipo: 'ojo',
